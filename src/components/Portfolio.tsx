  ...
  const projects = [
    {
      ...
      description: 'Complete IoT ecosystem for home automation with custom PCB design and mobile app control.',
    ...
    {
      title: 'Brand Campaign Video Series',
      category: 'Content Creation',
      description: 'Multi-platform video campaign for tech startup, achieving 2M+ views across social media.',
    ...
    },
    {
      ...
      category: 'Electronics Engineering',
      description: 'Low-power wireless sensor network for environmental monitoring with custom protocols.',
      image: 'https://images.pexels.com/photos/2599244/pexels-photo-2599244.jpeg?auto=compress&cs=tinysrgb&w=600',
      technologies: ['LoRa', 'Embedded C', 'Python', 'MQTT'],
      github: 'https://github.com',
      demo: 'https://demo.com',
      featured: false,
    },
    {
      ...
      description: 'Real-time analytics dashboard for content creators with AI-powered insights.',
    ...
    },
    {
      ...
      category: 'Content Creation',
      description: 'Award-winning short documentary on sustainable technology, featured in film festivals.',
      image: 'https://images.pexels.com/photos/1117132/pexels-photo-1117132.jpeg?auto=compress&cs=tinysrgb&w=600',
      technologies: ['RED Camera', 'Premiere Pro', 'After Effects'],
      github: 'https://github.com',
      demo: 'https://demo.com',
      featured: true,
    },
